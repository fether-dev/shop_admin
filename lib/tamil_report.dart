...
import 'package:imgpic/tamil_orderdetails.dart';
import 'package:intl/intl.dart';

class Tamil_ReportsData extends StatefulWidget {
  @override
  _Tamil_ReportsDataState createState() => _Tamil_ReportsDataState();
}
...
class _Tamil_ReportsDataState extends State<Tamil_ReportsData> {
  ...
  Future<String> report_data() async {
    ...
    final response = await http.get(
      "http://fluttertest.000webhostapp.com/reportdata.php?formatted=$formatted",
      //   await http.get( "http://192.168.122.1/ecart/disp_pimg.php",
    );
    print("response.body" + response.body);
          ...
          children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            new Text(
                              ...
                              style: new TextStyle(
                               ...
                               new Text('விநியோக நிலை ', textAlign: TextAlign.center, 
            ...
            new GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                  ...
                  builder: (BuildContext context) => new Tamil_Orderdetails(
                        list: data,
                        index: index,
                      )))
