...
class Tamil_EditStock extends StatefulWidget {
  final List list;
  final int index;
  
  Tamil_EditStock({this.list, this.index});

  @override
  _Tamil_EditStockState createState() => new _Tamil_EditStockState();
}
 
class _Tamil_EditStockState extends State<Tamil_EditStock> {
...
/*void conimgstrtofile(var p_img) async{
//final tempDir =await getTemporaryDirectory();
 // final path = tempDir.path;
  //int rand= new Math.Random().nextInt(100000);
//Img.Image image= Img.decodeImage(p_img.readAsBytesSync());
  Img.Image smallerImg = Img.copyResize(image, 500);
...
Future getImageCamera() async{
 ...
 Future upload(File img1) async {
  ...
  request.fields['id'] = product_id.text;
   ...
   request.fields['product_stack'] = product_stack.text;
...
List data = List();
  ...
  Widget build(BuildContext context) {
   ...
   appBar: new AppBar(
        title: new Text("பொருள் விவரங்களைத் திருத்துக",softWrap: true,overflow: TextOverflow.visible,style:new TextStyle(fontSize: 15.0,  )),
      ),
            ...
            new Column(
              ...
              SizedBox(
                  ...
                  decoration: new InputDecoration(
                    ...
                    labelText: "அடையாள எண்ணை உள்ளிடவும்",
 ...
 new Text('பிரிவை தேர்வு செய்க'),
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
              children: <Widget>[
                    Text("படத்தை மாற்றுக",style: new TextStyle(fontSize: 16.0,fontWeight: FontWeight.bold),),
                IconButton(
